...
class DeleteAction extends Action {
  ...
  _calculatePositions() {
    ...
    this._beginPos = this._squeezeSpaces(pos, this._endPos);
  }
...
class RemoveAction extends Action {
  ...
  _calculatePositions() {
    if (this._takeWholeLine()) {
      ...
      this._endPos = this._squeezeLines(pos, beginLine, endLine);
    } else {
      const pos = this.node.start;
      this._beginPos = this._squeezeSpaces(pos, this.endPos());

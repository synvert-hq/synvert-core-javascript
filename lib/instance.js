...
class Instance {
   ...
   */
  insert(code, options) {
    Instance.current.action.push(new InsertAction(Instance.current, code, options));
  }
  ...
  delete(selectors, options) {
    Instance.current.action.push(new DeleteAction(Instance.current, selectors, options));
  }
  ...
  replace(selector, options) {
    Instance.current.actions.push(new ReplaceAction(Instance.current, selector, options));
  }

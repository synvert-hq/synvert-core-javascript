...
class Rewriter {
  ...
  static register(group, name, rewriter) {
    global.synvertRewriters[group] = global.synvertRewriters[group] || {}
    global.synvertRewriters[group][name] = rewriter
  }
  ...
  static fetch(group, name) {
    return global.synvertRewriters[group][name]
  }

...
class IfAllCondition extends Condition {
   ...
   */
  constructor(instance, rules, options, function_, elseFunction) {
    super(instance, rules, function_);
    this.options = options;
    this.elseFunc = elseFunction;
  }
  ...
  process() {
    ...
    if (nodes.every(node => node.match(this.options.match))) {
      this.func.call(this.instance);
    } else {
